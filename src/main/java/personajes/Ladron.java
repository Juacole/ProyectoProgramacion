...
public class Ladron extends Personaje{
    ...
    public Ladron(String nombre, String raza, Artefacto artefacto) {
    ...
    public Ladron(String nombre, String raza, Arma arma, Artefacto artefacto) {
        super(nombre, raza, artefacto);
        setArma(arma);
    }

    public Ladron(String nombre, String raza, Armadura equipamiento, Artefacto artefacto) {
        super(nombre, raza, artefacto);
        setArmadura(equipamiento);
    }

    public Ladron(String nombre, String raza, Arma arma, Armadura equipamiento, Artefacto artefacto) {
        super(nombre, raza, artefacto);
        setArma(arma);
        setArmadura(equipamiento);
    }
